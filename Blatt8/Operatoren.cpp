...
using namespace std;
 ...
 a = !(--b == 0);	// ! ist der logische Operator NOT. a wird dem entgegengesetzten(booleschen) Wert der Aussage --b == 0 zugewiesen. Da b=2, also --b = 1 ungleich 0, ist die Aussage false; a w�re somit true. Da a aber vom Datentyp int ist kann dieser den Wert true nicht annehmen. H�chstens die Interpretation des Wertes 1 als true; bzw. 0 als false.
 a = 0 && 0 + 2;	// && ist der logische Operator AND. Da a weder 0 noch 2 ist, wird a also der Wert false zugewiesen.(wenn a nicht int w�re...); a w�re also entsprechend der Interpretation = 0.
 ...
 a = sizeof(int) * sizeof(a);	//a wird dem quadrat des Werts der gr��e (in bytes) zugewiesen, die ein integer hat, da sizeof(int) = 4 und sizeof(a) = 4. a ist also = 16.

 return 0;
 }
 /* Compiler-Werte:
 2=a 2=b	stimmt �berein
 17=a 2=b	stimmt �berein
 25=a 2=b	stimmt �berein
 250=a 2=b	stimmt �berein
 4=a 2=b	stimmt �berein
 1=a 1=b	b falsch
 0=a 1=b	b falsch
 2=a 2=b	a falsch weil b falsch -> a=++true *2 = (1+1)*2 =2
-10=a 2=b	stimmt �berein
-2=a 3=b	?
1=a 3=b		a stimmt �berein
0=a 3=b		a stimmt �berein
8=a 4=b		a falsch weil b falsch. b(3) wird mit ++b zu 4. 4+4=8=a.
16=a 4=b	stimmt �berein.
 */
